...
export const KakuseiController = {
    homePage: () => `${baseUrl}`,
    searchManga: (slug: string) => `${baseUrl}/?s=${encodeURIComponent(slug)}&post_type=wp-manga&op=&author=&artist=&release=&adult=`,
    searchMangaPerGenre: (genre: keyof Genres) => `${baseUrl}/?s=&post_type=wp-manga&genre[]=${genre}&op=&author=&artist=&release=&adult=`,
